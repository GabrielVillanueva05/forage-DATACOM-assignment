  ...
  return (
    <Map
      ...
      initialViewState={{
        ...
        maxBounds: convertBounds([110.0, -55.0, 180.0, 0.0]), //finding a nice spot for the map bounds
        zoom: 2, //setting an inital zoom
      }}
      padding={24}
      dragPan={{
        maxBounds: convertBounds(totalBounds), //dis allows the user to drag outside the region
      }}
      dragRotate={false} // I added this line to prevent the map from being rotated
    >
